module.exports = async (ctx, next) => {
  ...
  //Public route action
  if (role.type === 'public' && (route.action === 'handlewebhook' || route.action === 'savetrafficgateway' || route.action === 'savegeogateway' || route.action === 'alertconfirm' || route.action === 'alertconfig')) {
    // Execute the action.
    return await next();
  }
